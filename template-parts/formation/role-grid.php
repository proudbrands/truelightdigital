 ...
 *
 * Image URLs are placeholders (Unsplash) for the 2026-04-20 redesign —
 * replace with attachment IDs + wp_get_attachment_image_url() in Phase 2.
 *
...
$roles = [
  [
    ...
    'image'    => 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=70',
  ],
  [
    'slug'     => 'parish-secretary',
    'title'    => "I'm the parish secretary",
    'subtitle' => 'Carrying this for years.',
    'image'    => 'https://images.unsplash.com/photo-1552960562-daf630e9278b?w=600&q=70',
  ],
  [
    'slug'     => 'priest',
    'title'    => "I'm the priest",
    'subtitle' => 'Forming a champion, or backing one.',
    'image'    => 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=600&q=70',
  ],
  [
    'slug'     => 'ppc-chair',
    'title'    => "I'm on the PPC or I chair it",
    'subtitle' => 'Supporting the work structurally.',
    'image'    => 'https://images.unsplash.com/photo-1543269664-76bc3997d9ea?w=600&q=70',
  ],
  [
    'slug'     => 'diocesan-staff',
    'title'    => "I'm at the diocese",
    'subtitle' => 'Looking at this for a whole diocese.',
    'image'    => 'https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=600&q=70',
  ],
  [
    'slug'     => 'agency',
